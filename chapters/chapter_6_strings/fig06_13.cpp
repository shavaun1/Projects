...
using std::format; using std::cout; using std::regex; 
using std::regex_match;

int main()
{
  regex r1{"02215"};
  cout<<"Matching against: 00215\n"
    <<format("00215: {}; 51120: {}\n\n",
        regex_match("02215",r1),regex_match("51220",r1));

  regex r2{R"(\d{5})"};
  cout <<R"(Matching against; \{5})"<<"\n"
    <<format("02215: {}; 9876: {}\n\n",
        regex_match("02215",r2),regex_match("9876",r2));

  regex r3{"[A-Z][a-z]*"};
  cout<<"Matching agaist: [A-Z][a-z]*\n"
   << format("Wally: {}; eva: {}\n\n",
  ...
  cout<<"Matching against: labell?ed\n"
    <<format("labelled: {}; labeled: {}; labellled: {}\n\n",
        regex_match("labelled",r7),
        regex_match("labeled", r7),
